...
Generate images, videos, PDFs, presentations, research reports, music, spreadsheets, 3D models, memes, and more — all from natural language prompts inside Cursor.
...
Ask Cursor to generate any rich media — the plugin automatically routes tasks to CellCog:
